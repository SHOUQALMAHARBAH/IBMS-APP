...
| every approve control | 3 | Fourteen of fifteen still cannot send a combined-duty reason, so an office in COMBINED mode meets a 422 with nowhere to type. The refund control can. Recorded as the remaining work rather than left for an office to find. | OPEN — 14 of 15 |
