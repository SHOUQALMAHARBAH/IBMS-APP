...
Infrastructure (Part A + Part B), plus Part C **Domain A, Processes 1–8** — Lead
...
Domain A #9–10, Domains B–H, and Parts D–G (PDPL, dashboards, bilingual UI, final
