...
Infrastructure, plus the first Part C business module (Lead Management, Domain A #1) —
see root `README.md`. Policy, claims, and the rest of CRM/finance don't exist yet.
