...
### Part C · Domain F #47–56 — Compliance & Risk (begun), with these deferrals
...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  constraint can express — see their own entries below for full detail. **Not
  built**: #57 Internal Audit (`InternalAuditFinding`, the External Auditor's
  time-boxed access). Management reporting (#58–65), Supporting Operations (HR, procurement, IT,
