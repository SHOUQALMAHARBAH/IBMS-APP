...
### Part C · Domain D #31–36 — built, with these deferrals
...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  Commission Reconciliation (#36) are built** (see the Domain D table above — the full
  ...
  insurer statement, and `→ reversed` driven by a Process 22 cancellation);
  payment channels / bank-reconciliation / reporting (#37–40),
  Customer
