...
### Part C · Domain F #47–55 — Compliance & Risk (begun), with these deferrals
...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  backlog references — see their own entries below for full detail. **Not
  built**: internal audit (#56), the remaining #57
  item. Management reporting (#58–65), Supporting Operations (HR, procurement, IT,
