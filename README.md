...
### Part C · Domain D #31–32 — built, with these deferrals
...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  reporting modules. **Finance (Domain D) — Premium Billing (#31) + Collection (#32) are
  built** (see the Domain D table above — the full
  `Invoice → Receipt → Reconciliation → Remittance` cycle through the workflow engine,
  with a client-funds ledger entry at each money movement); accounting / commission /
  bank-reconciliation / reporting (#33–40),
  Customer
