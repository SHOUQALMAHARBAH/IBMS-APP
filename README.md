...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  **the last Domain G item built; #64 Executive Management Reporting deliberately
  ...
  answered by a real five-scenario coverage/gap-check endpoint. See all
  six entries below for full detail. **Not built/unverified**: #74
...
**Part C #68 — Internal Information Technology (Domain H, Process 68)** —
  ...
  **Deferred**: everything already listed under § Known gaps, A.10 (no
  ...
  stays three local databases). Nothing #68-specific beyond that. #74
  (Knowledge Management) remains unbuilt, with its own permission already
  seeded (#69 Cybersecurity, #70 Document Management, #71 Vendor
  Management, and #72-73 BCP/DR, the next four entries below, are now
  built).
...
**Part C #69 — Cybersecurity (Domain H, Process 69)** — **verified AND
  ...
  **Deferred**: Part A's own gaps (hardware-token MFA, a real KMS/HSM,
  ...
  by #69's own text, not built here. #74 (Knowledge Management) remains
  unbuilt, with its own permission already seeded (#70 Document
  Management, #71 Vendor Management, and #72-73 BCP/DR, the next three
  entries below, are now built).
...
**Part C #70 — Document Management (Domain H, Process 70)** — full version
  ...
  **Deferred**: hardening `Document_previousVersionId_fkey` from
  ...
  re-derived for later versions. #74 (Knowledge Management) remains
  unbuilt, with its own permission already seeded (#71 Vendor Management
  and #72-73 BCP/DR, the next two entries below, are now built).
...
**Part C #71 — Vendor Management (Domain H, Process 71 — M07)** — risk
  ...
  **Deferred**: M08 (`DataSharingApproval`) remains a separate,
  ...
  `CLAIM_LARGE_THRESHOLD_JOD`. #74 (Knowledge Management) remains unbuilt,
  with its own permission already seeded (#72-73 BCP/DR, the next entry
  below, is now built).
...
**Part C #72-73 — Business Continuity & Disaster Recovery (Domain H,
  ...
  **Deferred**: the database backup/restore drill remains the one piece
  ...
  #74 (Knowledge Management) remains unbuilt, with its own permission
  already seeded.
