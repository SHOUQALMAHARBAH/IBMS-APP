...
### Part C · Domain D #31–35 — built, with these deferrals
...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  Client Accounting (#33), Insurer Accounting (#34) + Commission Calculation (#35) are
  built** (see the Domain D table above — the full
  ...
  remittance-obligations report per insurer, and the governed `CommissionAgreement` rate
  table + `CommissionLedgerEntry` ledger with the manual-override maker/checker);
  commission reconciliation / bank-reconciliation / reporting (#36–40),
  Customer
