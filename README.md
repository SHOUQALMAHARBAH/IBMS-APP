...
### Part C · Domain C #23–25 — built, with these deferrals
...
- **Domains C–H** — Claims (#26 Assessment, #27
  Follow-up, #28 Settlement, #29 Loss Ratio / Analytics, #30 closure — #23 Claim
  Notification, #24 Claim Registration with Insurer and #25 Claim Documentation are
  **built**, see the Domain C table above), Finance (billing / collection / commission / reconciliation, #31–40), Customer
