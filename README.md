...
### Part C · Domain F #47–54 — Compliance & Risk (begun), with these deferrals
...
- **Domains C–H** — Claims **#23–30 are built** (Notification, Registration, Documentation,
  ...
  Checking discrepancy already auto-logs (Process 20) — see their own entries below for
  full detail. **Not
  built**: incident/breach management (#55), internal audit (#56), the remaining #57
