...
export const CUSTOMERS = {
  AR: {
    ...
    customerRevealJustificationRequired: 'يلزم إدخال مبرر مكتوب لكشف هذا الحقل.',
    ...
    customerNeedsAssessmentNoPermission: 'لا تملك صلاحية needs-assessment.create.',
    ...
    customerWizardDocumentsIntroPrefix: 'مستندات الطلب/العرض لملف اعرف عميلك الخاص بـ',
    ...
    customerWizardClassificationHighlyConfidentialOption: 'سري للغاية (مثال: صورة الهوية)',
    ...
    customerNewNoPermission: 'لا تملك صلاحية customer.create، لذا لا يوجد ما يمكن فعله هنا.',
    ...
    kycQueueNoApprovePermission: 'لا تملك صلاحية kyc.approve — هذه القائمة مخصصة للالتزام فقط.',
    kycQueueNoPermission: 'لا تملك صلاحية kyc.approve أو kyc.capture، لذا لا يوجد ما يمكن عرضه هنا.',
  ...
  EN: {
    ...
    customerRevealJustificationLabel: 'Justification for revealing {field} (Part 10.6, logged)',
    customerRevealJustificationRequired: 'A written justification is required to reveal this field.',
    ...
    customerNeedsAssessmentNoPermission: "You don't hold the needs-assessment.create permission.",
    ...
    customerRiskSurveyNoPermission: "You don't hold the risk-profile.read permission.",
    ...
    customerInsuranceProgramNoPermission: "You don't hold the program.read permission.",
    ...
    customerCrossSellNoPermission: "You don't hold the cross-sell.read permission.",
    ...
    customerCrmNoPermission: "You don't hold the customer.360-view.read permission.",
    ...
    customerWizardUbosIntroPrefix: 'Record every individual with significant ownership or control of',
    customerWizardUbosIntroSuffix: '.',
    ...
    customerWizardClassificationHighlyConfidentialOption: 'Highly confidential (e.g. ID scan)',
    ...
    customerNewIntro:
      ...
      'and approval.',
    customerNewNoPermission: "You don't hold the customer.create permission, so there's nothing to do here.",
    ...
    kycQueueNoApprovePermission: "You don't hold the kyc.approve permission — this queue is Compliance-only.",
    kycQueueNoPermission: "You don't hold the kyc.approve/kyc.capture permission, so there's nothing to show here.",
