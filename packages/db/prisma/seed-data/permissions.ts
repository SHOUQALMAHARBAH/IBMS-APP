...
const complianceRisk: PermissionSeed[] = [
  ...
  { code: 'internal-controls.view', module: 'compliance-risk', description: 'View the periodic self-approval (maker/checker) audit report', roles: [COMPLIANCE, EXEC, AUDITOR] },
